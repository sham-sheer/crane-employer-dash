    ...
    <>
      <div>
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 bg-cyan-600 bg-opacity-75" />
            </Transition.Child>
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-cyan-800 pt-5 pb-4">
                  <Transition.Child
                    as={Fragment}
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col bg-cyan-800">
            <div className="h-18 flex flex-shrink-0 items-center bg-cyan-800 px-4">
              <img
